async function makeDepositAndwidthdraw() {
    ...
    var  stackNabi  = [
        ...
        {
            "inputs": [],
            "name": "stackNTockenSmartContractAddress",
            "outputs": [
                {
                    "internalType": "address",
                    "name": "",
        ...
        {
            "inputs": [],
            "name": "weth9SmartContractAddress",
            "outputs": [
                {
                    "internalType": "address",
                    "name": "",
