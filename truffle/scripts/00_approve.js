async function approve() {
    ...
    Contract.methods.allowance(accountAddress, addrContractToGiveApprove).call().then(console.log);
    Contract.methods.balanceOf(accountAddress).call().then(console.log);
    await Contract.methods.approve(addrContractToGiveApprove, 10000000000).send({ from: accountAddress});
    Contract.methods.allowance(accountAddress, addrContractToGiveApprove).call().then(console.log);  
